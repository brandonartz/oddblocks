...
public class OddBlocksTier2Feature extends Feature<DefaultFeatureConfig> {
    ...
    public static void registerFeature(){  
        Feature<DefaultFeatureConfig> ODD_FEATURE = Registry.register(Registry.FEATURE, identifier, new OddBlocksTier2Feature(DefaultFeatureConfig.CODEC));  
        ...
        PlacedFeature OVERWORLD_ODD_PLACED_FEATURE = new PlacedFeature(
            ...
            Arrays.asList(
              RarityFilterPlacementModifier.of(95), 
