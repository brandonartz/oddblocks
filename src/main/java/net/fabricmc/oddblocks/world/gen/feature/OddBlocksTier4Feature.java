...
public class OddBlocksTier4Feature extends Feature<DefaultFeatureConfig> {
    ...
    private static final Feature<DefaultFeatureConfig> ODD_FEATURE = Registry.register(Registry.FEATURE, identifier, new OddBlocksTier4Feature(DefaultFeatureConfig.CODEC));  
