...
public class OddBlocksTier9Feature extends Feature<DefaultFeatureConfig> {
    ...
    public static void registerFeature(){  
        Feature<DefaultFeatureConfig> ODD_FEATURE = Registry.register(Registry.FEATURE, identifier, new OddBlocksTier9Feature(DefaultFeatureConfig.CODEC)); 
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        if(blockPos.isWithinDistance(START_BLOCK, 700)){
            return true;
        }
